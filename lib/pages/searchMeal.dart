...
class _SearchMealScreenState extends State<SearchMealScreen> {
  ...
  @override
  void initState() {
    _searchMeal = API_Manager().getsearchMeal(widget.id);
    super.initState();
  }
        ...
        child: Column(
          children: [
            Container(
              ...
              child: FutureBuilder<SearchMeal>(
                future: _searchMeal,
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          Map<String, dynamic> mealId = {
                                            "id": snapshot.data.meals[index]
                                                ['idMeal'],
                                            "name": snapshot.data.meals[index]
                                                ['strMeal'],
