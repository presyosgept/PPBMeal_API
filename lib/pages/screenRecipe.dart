...
class ScreenRecipe extends StatefulWidget {
  ...
  @override
  _ScreenRecipeState createState() => _ScreenRecipeState();
}
...
class _ScreenRecipeState extends State<ScreenRecipe> {
  ...
  @override
  void initState() {
    _recipeMeal = API_Manager().getRecipeMeal(widget.mId);
    super.initState();
  }
  ...
  trappingDialog(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
          return FutureBuilder<RecipeMeal>(
              future: _recipeMeal,
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  var snap = snapshot.data.meals;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(
              child: FutureBuilder<RecipeMeal>(
                  future: _recipeMeal,
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var snap = snapshot.data.meals;
